...
function renderWeakSpots() {
 ...
 <div class="weak-spots-title">Weak Areas <span class="weak-spots-sub">- focus on these</span></div>
...
function renderExamCountdown() {
 ...
 if (!upcoming.length) {
 section.innerHTML = `<div class="exam-empty-prompt">Add exam dates in <button class="exam-settings-link" onclick="toggleSettings()">Settings</button> to see your countdown</div>`;
 return;
 }
